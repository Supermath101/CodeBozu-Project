...
file_pos = open(folder + "/" + "politico_-%.csv","w")
file_neg = open(folder + "/" + "politico_+%.csv","w")

file = open(folder + "/" + "politico.csv","r")
...
file_pos = open(folder + "/" + "politico_+%.csv", "r")
